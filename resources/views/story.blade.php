    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-12 mt-5" id="more-top">
                ...
                <div class="row space my-5"></div>
                <a class="ml-3" style="color: white;font-family: Poppins;font-size:12pt;">Our Story</a><br>
                <img src="{{asset('assets/more/line.png')}}" width="30%" class="ml-3">
                <h1 class="ml-3" style="color: white; font-size:50pt; font-family: PoppinsSB;"><b>{{$story->title}}</b>
                </h1>
                <div class="row">
                    <div class="col-lg-4 col-sm-6 col-11 mb-4 ml-3"
                         style="color: white;font-family: Poppins;font-size:13pt;">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-12 col-sm-12 col-12 my-5">
                    <p style="text-align: justify; font-family: Poppins; Line-height: 28.5px;"
