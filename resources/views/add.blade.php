        ...
        <div class="row justify-content-center">
                ...
                <form method="POST" action="insertMember">
                    ...
                    <div class="row justify-content-center animate__animated animate__fadeIn" >
                        <div class="col-lg-6 col-12 px-5 pb-4">
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-sm-6 col-12 mt-3">
                                    <label for="posisi" style="font-size: 14px; font-weight: bold;">Posisi</label>
                                    <input id="posisi" style="border-radius:10px;" type="name" class="form-control" name="posisi" required autofocus>
                                </div>
                                <div class="col-lg-6 col-sm-6 col-12 mt-3">
                                    <label for="tanggalGabung" style="font-size: 14px; font-weight: bold;">Tanggal Gabung</label>
                                    <input id="tanggalGabung" style="border-radius:10px;" type="date" class="form-control" name="tanggalGabung" required autofocus>
                                </div>
                            </div>
                            <label class="mt-3" for="foto" style="font-size: 14px; font-weight: bold;">Photo Attachment</label>
                            <div class="drop-zone">
                        ...
                        <div class="col-lg-6 col-12 px-5 pb-4">
                            ...
                            <textarea id="cerita" style="border-radius:10px;" type="text" class="form-control col-lg-12 col-12" rows="15" name="cerita" required autofocus>
                                </textarea>
                        </div>
                    </div>
                    <div class="row  animate__animated animate__fadeIn">
            ...
            <div class="section" id="postmerch">
                ...
                <form method="POST" action="insertMerch">
                    ...
                    <div class="row justify-content-center animate__animated animate__fadeIn" >
                        <div class="col-lg-6 col-12 px-5 pb-4">
                            <label for="namaBarang" style="font-size: 14px; font-weight: bold;">Nama Barang</label>
                            <input id="namaBarang" style="border-radius:10px;" type="name" class="form-control col-lg-12 col-12" name="namaBarang" required autofocus>
                            <div class="row">
                                <div class="col-lg-6 col-sm-6 col-12 mt-3">
                                    <label for="harga" style="font-size: 14px; font-weight: bold;">Harga</label>
                                    <input id="harga" style="border-radius:10px;" type="number" class="form-control" name="harga" required autofocus>
                                </div>
                                <div class="col-lg-6 col-sm-6 col-12 mt-3">
                            ...
                            <label class="mt-3" for="fotobarang" style="font-size: 14px; font-weight: bold;">Photo Attachment</label>
                            <div class="drop-zone">
                                <span class="drop-zone__prompt">Drop file here or click to Upload</span>
                                <input class="drop-zone__input" type="file" name="files" id="file"/>
                            </div>
                        ...
                        <div class="col-lg-6 col-12 px-5 pb-4">
                            ...
                            <textarea id="deskripsi" style="border-radius:10px;" type="text" class="form-control col-lg-12 col-12" rows="15" name="deskripsi" required autofocus>
                                </textarea>
                        </div>
                    </div>
                    <div class="row  animate__animated animate__fadeIn">
