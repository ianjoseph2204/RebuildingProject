            ...
            <div class="row justify-content-center">
                <div class="col-lg-11 col-10 mt-5">
                    <div class="row" style="margin-right: 0; margin-left: 0">
                        <a class="col mt-5 mx-1 px-3 py-2 text-center" href="#buttonpostarticle" id="post-article-button"><b>
                                Post an Article</b></a>
                            ...
                            <div class="row justify-content-center  animate__animated animate__fadeIn">
                                <div class="col-lg-6 col-12 px-5 pb-4">
                                    <label for="user-name" id="subJudulForm">Nama
                                        Lengkap</label>
                                    <input id="user-name" style="border-radius:10px;border: 0" type="name" class="form-control col-lg-12 col-12" name="writer" required autofocus>
                                    <div class="row">
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-sm-6 col-12">
                                            <label for="titlearticle" id="subJudulForm">Judul
                                                Artikel</label>
                                            <input id="titlearticle" style="border-radius:10px;border: 0" type="name" class="form-control col-lg-12 col-12" name="title" required autofocus>
                                        </div>
                                        <div class="col-lg-6 col-sm-6 col-12">
                                            <label for="category" id="subJudulForm">Kategori Artikel</label>
                                            <input id="category" style="border-radius:10px;border: 0" type="category" class="form-control col-lg-12 col-12" name="category_id" required autofocus>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row justify-content  animate__animated animate__fadeIn">
                                <div class="col-lg-12 col-12 px-5">
                                    <label for="article" id="subJudulForm">Konten
                                        Artikel</label>
                                    <textarea id="article" style="border-radius:10px;border: 0" type="text" class="form-control col-lg-12 col-12" rows="8" name="content" required autofocus></textarea>
                                </div>
                            ...
                            <div class="row  animate__animated animate__fadeIn">
                                <div class="col-lg-5 col-10 mx-5 mb-4" style="border-radius: 20px;background-color: white;">
                                    <div style="float: left; margin-top: 5px;">
                                        <button class="btn"  style="padding:0; margin:2px"><i class="fa fa-close"></i></button>
                                    </div>
                                    <div class="column">
                                        <img style="width: 100%;" src="assets/image.png" alt="Avatar">
                                    </div>

                                    <div class="column" style="display:flex; height: 100%;justify-content: center;align-items: center;">
                        ...
                        <form method="POST" action="/users" enctype="multipart/form-data">
                            ...
                            <div class="row justify-content-center animate__animated animate__fadeIn">
                                <div class="col-lg-6 col-12 px-5 pb-4">
                                    ...
                                    <input id="user-name" style="border-radius:10px;border: 0" class="form-control col-lg-12 col-12" name="user_name" required autofocus>
                                </div>

                                <div class="col-lg-6 col-12 px-5 pb-4 form-group">
                                    <label for="user-position" id="subJudulForm">Jabatan</label>

                                    <select placeholder="Pilih Jabatan" class="form-control" name="user_position_id" id="user-position" style="border-radius:10px; border: 0" required autofocus>
                            ...
                            <div class="row justify-content  animate__animated animate__fadeIn">
                                <div class="col-lg-12 col-12 px-5 pb-3">
                                    ...
                                    <textarea id="user-story" style="border-radius:10px;border: 0" type="text" class="form-control col-lg-12 col-12" rows="8" name="user_story" required autofocus></textarea>
                                </div>

                                <div class="col-lg-6 col-12 px-5 pb-4 pt-2">
                                    <label class="col-md-8 px-0 col-form-label" id="subJudulForm">Photo Attachment</label>
                                    <input type="file" class="form-control-file-center" name="user_photo" id="user-photo" hidden />
                        ...
                        <form method="POST" action="insertMerch">
                            ...
                            <div class="row justify-content-center animate__animated animate__fadeIn">
                                <div class="col-lg-6 col-12 px-5 pb-4">
                                    <label for="namaBarang" id="subJudulForm">Nama
                                        Barang</label>
                                    <input id="namaBarang" style="border-radius:10px;border: 0" type="name" class="form-control col-lg-12 col-12" name="namaBarang" required autofocus>
                                </div>

                                <div class="col-lg-6 col-12 px-5 pb-4">
                                    <label for="harga" id="subJudulForm">Harga</label>
                                    <input id="harga" style="border-radius:10px;border: 0" type="number" class="form-control" name="harga" required autofocus>
                                </div>
                            </div>
                            ...
                            <div class="row justify-content  animate__animated animate__fadeIn">
                                <div class="col-lg-12 col-12 px-5 pb-3">
                                    ...
                                    <textarea id="deskripsi" style="border-radius:10px;border: 0" type="text" class="form-control col-lg-12 col-12" rows="8" name="deskripsi" required autofocus></textarea>
                                </div>
                                <div class="col-lg-6 col-12 px-5 pb-4 pt-2">
                                    <label for="fotobarang" class="col-md-8 px-0 col-form-label" id="subJudulForm">Photo
                                        Attachment</label>
                                    <input type="file" class="form-control-file-center upload-button" name="image" id="txtChooseFile" hidden />
                                    <label class="upload-button" for="txtChooseFile">+ Add Media</label>
                                </div>
                            </div>
