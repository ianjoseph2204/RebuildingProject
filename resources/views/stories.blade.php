        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-xl-8 col-lg-8 mt-5 text-center">
                    <h1 class="grid-1 my-2" style="font-size: 60px;height: 18%;">
                        <span class="grid-2">Our</span> Story</h1>
                </div>
            </div>
        </div>
    </section>
                            ...
                            <div class="card-story">
                                ...
                                <div class="card" style="border-radius: 0 0 17px 17px">
                                    <div class="box pt-3 px-4">
                                        ...
                                        <br>
                                        <h3 class="grid-1" style="margin: 0">{{strlen($story->title) > 11 ?
                                            substr($story->title, 0, 11).'...' : $story->title}}</h3>
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-xl-12 col-lg-12 text-right" style="padding: 0">
                                                <form action="stories/{{$story->id}}">
                                                    <button class="btn px-3 py-2 my-3" id="login"><b>Read More</b>
                                                    </button>
                                                </form>
                                            </div>
                                        </div>
