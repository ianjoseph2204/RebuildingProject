                ...
                <div class="row p-5 my-2 justify-content-start">
                    <div class="col-lg-3 col-md-6">
                        <div class="cardProgramK">
                            <div class="card-body">
                                <img class="mt-5" src="{{asset('assets/home/image1.png')}}" alt="Avatar"
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="cardProgramK">
                            <div class="card-body">
                                <img class="mt-5" src="{{asset('assets/home/image4.png')}}" alt="Avatar"
                                     style="width:40%"><br><br>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="cardWWD">
                        <div class="card-body">
                            ...
                            <p id="quote"><b>Mendorong partisipasi anak-anak muda untuk berkontribusi dalam meningkatkan
