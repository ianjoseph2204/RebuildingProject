    ...
    <div class="container-fluid my-5">
        <div class="row justify-content-center">
            ...
            <div class="col-lg-5 col-sm-6 col-12 p-5 text-center" style="background-color:#FBEFE4">
                ...
                <img src="assets/get-involved/qr.png" width="40%" class="mx-1 my-1">
...
<section id="02">
    <div class="container my-5">
        <div class="row justify-content-center">
            ...
            <img src="assets/get-involved/tshirt.png" class="card-picture">
                <div class="card p-3">
            ...
            <div class="col-lg-4 col-sm-4 col-10 my-4">
            <img src="assets/get-involved/bottle.png" class="card-picture">
                <div class="card p-3">
                    <div class="box p-xl-3 p-lg-3 p-2">
            ...
            <div class="col-lg-4 col-sm-4 col-10 my-4">
            <img src="assets/get-involved/watch.png" class="card-picture">
                <div class="card p-3">
                    <div class="box p-xl-3 p-lg-3 p-2">
...
<script> var get-involved = document.getElementById('get-involved').id = 'this'; </script>
@endsection
